...
val biblicalLevelBadges: List<BiblicalBadge> = listOf(
    ...
    // RARO — níveis 8–12
    BiblicalBadge("semente_da_fe", "Semente da Fé", "Uma nova etapa em que conhecimento e prática começam a florescer.", BadgeCategory.LEVEL, 8, BadgeFrameStyle.PROFILE_EMBLEM, 0xFF7CB342, "100 XP + 2 capítulos e 2 respostas corretas neste nível", ProfileEmblemRarity.RARE),
